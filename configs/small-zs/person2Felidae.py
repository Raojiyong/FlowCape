...
model = dict(
    type='CapeXModel',
    pretrained='pretrain/swinv2/swinv2_small_1k_500k.pth',
    # pretrained="swinv2_base",
    text_pretrained='pretrain/Alibaba-NLP/gte-base-en-v1.5',
    ...
    keypoint_head=dict(
        ...
        transformer=dict(
            ...
            # encoder_type="two_way_attn"
        ),
        share_kpt_branch=False,
        num_decoder_layer=3,
        with_heatmap_loss=True,
        # with_decoder_attention_loss=True,
...
data = dict(
    ...
    workers_per_gpu=8,
    train=dict(
        type='SpecieTransformerPoseDataset',
        ann_file=f'{data_root}/annotations_by_class/supercategory_person.json',
    ...
    val=dict(
        type='SpecieTransformerPoseDataset',
        ann_file=f'{data_root}/annotations_by_class/supercategory_Felidae.json',
        img_prefix=f'{data_root}/images/',
        # img_prefix=f'{data_root}',
        data_cfg=data_cfg,
        valid_class_ids=None,
